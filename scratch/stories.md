...
**Tech Stack**: Next.js 14 (Pages Router) + Headless WordPress via WPGraphQL + Apollo Client + Sass
...
### Story 6.2: Design Markdown Structure
...
### Story 6.3: Build Migration Tooling
...
### Story 6.4: Implement Local Content Layer
...
### Story 6.5: Migrate Content (Incremental)
...
### Story 6.7: Handle WordPress-Specific Features
...
### Story 6.8: Decommission WordPress
