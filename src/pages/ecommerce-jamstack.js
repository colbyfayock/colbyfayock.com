...
const ECOMMERCE_JAMSTACK_PAGE_URI = '/ecommerce-jamstack/';
    ...
    <Layout pageClassName={styles.pageNewsletter}>
      ...
      <Content>
        ...
        <Section className={styles.newsletterFormSection}>
          <Container>
            <FormConvertkit className={styles.newsletterForm} formId="2418778" />
          </Container>
        </Section>
      </Content>
    </Layout>
...
export async function getStaticProps() {
  const { page } = await getPageByUri(ECOMMERCE_JAMSTACK_PAGE_URI);
